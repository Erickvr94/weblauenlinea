          ...
          <div class="" >
            <!--<span class="w3-right w3-opacity"></span>Letra a la esquina superior derecha -->
                ...
                <table class="table w3-responsive">
                        ...
                        <?php 
                            $ct = new Control();
                            $arraySolicitudesEstado =  $ct->estadoDeivery();  
                            ...
                            $programa4 ="Soundtracks"; 
                                ...
                                foreach($arraySolicitudesEstado as $rs) {
                                    if(($rs->ESTADO_DLV == "Pendiente")&&(($rs->PROGRAMA_DLV==$programa1)||($rs->PROGRAMA_DLV==$programa2)||($rs->PROGRAMA_DLV==$programa3)||($rs->PROGRAMA_DLV==$programa4))){  ?>
                              <tbody>
                                <tr class="color1">
                                  ...
                                  <td class="dedicatira"  > <?php echo $rs->DEDICATORIA_DLV ?> </td>
                                </tr>
                            </tbody>

                                 <?php }
                                  else if(($rs->ESTADO_DLV == "Atendido")&&(($rs->PROGRAMA_DLV==$programa1)||($rs->PROGRAMA_DLV==$programa2)||($rs->PROGRAMA_DLV==$programa3)||($rs->PROGRAMA_DLV==$programa4))){  ?>
                          <tbody>
                                <tr class="color1">
                                  <td class="w3-center "> <?php echo  $rs->id_delivery ?> </td>
                                  <td class="w3-center "> <?php echo  $rs->FECHA_DLV ?> </td>
